...
Namespace SubContractingPO
    ...
    Friend Class GeneralSettings
        ...
        Public Overrides Sub OnInitializeComponent()
            ...
            Me.CheckBox22 = CType(Me.GetItem("procval").Specific, SAPbouiCOM.CheckBox)
            ...
            Me.StaticText18 = CType(Me.GetItem("lblprice").Specific, SAPbouiCOM.StaticText)
            Me.OptionBtn4 = CType(Me.GetItem("optsp").Specific, SAPbouiCOM.OptionBtn)
            Me.OptionBtn5 = CType(Me.GetItem("optvsp").Specific, SAPbouiCOM.OptionBtn)
            Me.CheckBox27 = CType(Me.GetItem("protype").Specific, SAPbouiCOM.CheckBox)
            Me.OptionBtn6 = CType(Me.GetItem("optcsp").Specific, SAPbouiCOM.OptionBtn)
            Me.CheckBox29 = CType(Me.GetItem("revplanqty").Specific, SAPbouiCOM.CheckBox)
            Me.EditText14 = CType(Me.GetItem("txtudo").Specific, SAPbouiCOM.EditText)
            Me.CheckBox30 = CType(Me.GetItem("chkgififo").Specific, SAPbouiCOM.CheckBox)
        ...
        Private Sub OnCustomInitialize()
            Try
                ...
                OptionBtn5.GroupWith("optsp")
                OptionBtn6.GroupWith("optvsp")
        ...
        Private Sub FieldSize()
            Try
                ...
                CheckBox27.Item.Height = CheckBox27.Item.Height + 2
                CheckBox29.Item.Height = CheckBox29.Item.Height + 2
                CheckBox30.Item.Height = CheckBox30.Item.Height + 2
...
#End Region
        ...
        Private Sub Button0_ClickBefore(sboObject As System.Object, pVal As SAPbouiCOM.SBOItemEventArg, ByRef BubbleEvent As System.Boolean) Handles Button0.ClickBefore
            Try
                ...
                If CheckBox14.Checked = True Then
                    ...
                    End If
                End If
                If OptionBtn5.Selected = True Then
                    If EditText14.Value = "" Then
                        objaddon.objapplication.StatusBar.SetText("Please update the UDO Code in Price from UDO...", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                        BubbleEvent = False : Exit Sub
                    End If
                End If
            Catch ex As Exception
        ...
        Private WithEvents CheckBox27 As SAPbouiCOM.CheckBox
        Private WithEvents OptionBtn6 As SAPbouiCOM.OptionBtn
        Private WithEvents CheckBox29 As SAPbouiCOM.CheckBox
        ...
        Private Sub EditText14_ChooseFromListBefore(sboObject As Object, pVal As SAPbouiCOM.SBOItemEventArg, ByRef BubbleEvent As Boolean) Handles EditText14.ChooseFromListBefore
            If pVal.ActionSuccess = True Then Exit Sub
            Try
                Dim oCFL As SAPbouiCOM.ChooseFromList = objform.ChooseFromLists.Item("CFL_UDO")
                Dim oConds As SAPbouiCOM.Conditions
                Dim oCond As SAPbouiCOM.Condition
                Dim oEmptyConds As New SAPbouiCOM.Conditions
                ...
                'oCond = oConds.Add()
                'oCond.Alias = "CanDefForm"
                'oCond.Operation = SAPbouiCOM.BoConditionOperation.co_EQUAL
                'oCond.CondVal = "Y"
                'oCond.Relationship = SAPbouiCOM.BoConditionRelationship.cr_AND
                'oCond = oConds.Add()
                'oCond.Alias = "MenuItem"
                'oCond.Operation = SAPbouiCOM.BoConditionOperation.co_EQUAL
                'oCond.CondVal = "Y"
                If objaddon.HANA Then
                    strQuery = "Select ""TableName"",""Code"", ""Name"" from OUDO where ""CanDefForm""='Y' and ""MenuItem""='Y'"
                Else
                    strQuery = "Select TableName,Code, Name from OUDO where CanDefForm='Y' and MenuItem='Y'"
                End If
        ...
        Private Sub EditText14_ChooseFromListAfter(sboObject As Object, pVal As SAPbouiCOM.SBOItemEventArg) Handles EditText14.ChooseFromListAfter
            Try
                ...
                If Not pCFL.SelectedObjects Is Nothing Then
                    Try
                        EditText14.Value = pCFL.SelectedObjects.Columns.Item("TableName").Cells.Item(0).Value
                    Catch ex As Exception
                    End Try
                End If
            Catch ex As Exception
        ...
        Private WithEvents CheckBox30 As SAPbouiCOM.CheckBox
    End Class
End Namespace
