...
Namespace SubContractingPO
    <FormAttribute("DistRule", "SubContractingPO/FrmDistRule.b1f")>
    Friend Class FrmDistRule
        ...
        Private Sub Button0_ClickAfter(sboObject As Object, pVal As SAPbouiCOM.SBOItemEventArg) Handles Button0.ClickAfter
            Try
                ...
                Dim objSubConform As SAPbouiCOM.Form
                Dim objMatrix As SAPbouiCOM.Matrix
                objSubConform = objaddon.objapplication.Forms.GetForm("SUBCTPO", FormCount)
                objMatrix = objSubConform.Items.Item("MtxinputN").Specific
                Dim Row1 As Integer = objMatrix.GetCellFocus.rowIndex()
                Dim Row As Integer = objMatrix.GetNextSelectedRow()
                Dim code As String = ""
